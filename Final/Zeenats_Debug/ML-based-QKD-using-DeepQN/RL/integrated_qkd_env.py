...
class IntegratedQKDEnv:
    ...
    def reset(self):
        ...
        eve_present = random.random() < 0.5
        eve_intercept_ratio = random.uniform(0.3, 1.0) if eve_present else 0.0
    ...
    def _compute_reward(self, action: int) -> float:
        ...
        # Reward for generating key bits
        reward += self.current_sifted_length * 0.1
        
        # Penalty for high QBER
